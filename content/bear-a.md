...
<img src="img/query/result_beara-dm-s-low.svg" alt="[BEAR-A S?? low]" height="200em">
<figcaption markdown="block">
Average DM query results for S?? triple patterns with a low cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-s-high">
<img src="img/query/result_beara-dm-s-high.svg" alt="[BEAR-A S?? high]" height="200em">
<figcaption markdown="block">
Average DM query results for S?? triple patterns with a high cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-p-low">
<img src="img/query/result_beara-dm-p-low.svg" alt="[BEAR-A ?P? low]" height="200em">
<figcaption markdown="block">
Average DM query results for ?P? triple patterns with a low cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-p-high">
<img src="img/query/result_beara-dm-p-high.svg" alt="[BEAR-A ?P? high]" height="200em">
<figcaption markdown="block">
Average DM query results for ?P? triple patterns with a high cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-o-low">
<img src="img/query/result_beara-dm-o-low.svg" alt="[BEAR-A ??O low]" height="200em">
<figcaption markdown="block">
Average DM query results for ??O triple patterns with a low cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-o-high">
<img src="img/query/result_beara-dm-o-high.svg" alt="[BEAR-A ??O high]" height="200em">
<figcaption markdown="block">
Average DM query results for ??O triple patterns with a high cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-sp-low">
<img src="img/query/result_beara-dm-sp-low.svg" alt="[BEAR-A SP? low]" height="200em">
<figcaption markdown="block">
Average DM query results for SP? triple patterns with a low cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-sp-high">
<img src="img/query/result_beara-dm-sp-high.svg" alt="[BEAR-A SP? high]" height="200em">
<figcaption markdown="block">
Average DM query results for SP? triple patterns with a high cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-so-low">
<img src="img/query/result_beara-dm-so-low.svg" alt="[BEAR-A S?O low]" height="200em">
<figcaption markdown="block">
Average DM query results for S?O triple patterns with a low cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-po-low">
<img src="img/query/result_beara-dm-po-low.svg" alt="[BEAR-A ?PO low]" height="200em">
<figcaption markdown="block">
Average DM query results for ?PO triple patterns with a low cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-po-high">
<img src="img/query/result_beara-dm-po-high.svg" alt="[BEAR-A ?PO high]" height="200em">
<figcaption markdown="block">
Average DM query results for ?PO triple patterns with a high cardinality.
</figcaption>
</figure>

<figure id="result_beara-dm-spo">
<img src="img/query/result_beara-dm-spo.svg" alt="[BEAR-A SPO]" height="200em">
<figcaption markdown="block">
Average DM query results for SPO triple patterns.
</figcaption>
</figure>

<figure id="result_beara-vq-s-low">
<img src="img/query/result_beara-vq-s-low.svg" alt="[BEAR-A S?? low]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-s-high.svg" alt="[BEAR-A S?? high]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-p-low.svg" alt="[BEAR-A ?P? low]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-p-high.svg" alt="[BEAR-A ?P? high]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-o-low.svg" alt="[BEAR-A ??O low]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-o-high.svg" alt="[BEAR-A ??O high]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-sp-low.svg" alt="[BEAR-A SP? low]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-sp-high.svg" alt="[BEAR-A SP? high]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-so-low.svg" alt="[BEAR-A S?O low]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-po-low.svg" alt="[BEAR-A ?PO low]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-po-high.svg" alt="[BEAR-A ?PO high]" height="200em">
<figcaption markdown="block">
...
<img src="img/query/result_beara-vq-spo.svg" alt="[BEAR-A SPO]" height="200em">
<figcaption markdown="block">
