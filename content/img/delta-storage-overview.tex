...
\begin{tikzpicture}[
    ...
    % Additions trees    
    \node[treenode] (asporoot)        {SPO};
    \node[treenode,below=of asporoot.south west] (aspo1) {\ldots};
    \node[treenode,below=of asporoot.south east] (aspo2) {\ldots};
    \draw[-,thick](aspo1) -- (asporoot);
    \draw[-,thick](aspo2) -- (asporoot);
    \node[treenode,right=of asporoot] (aposroot)        {POS};
    \node[treenode,below=of aposroot.south west] (apos1) {\ldots};
    \node[treenode,below=of aposroot.south east] (apos2) {\ldots};
    \draw[-,thick](apos1) -- (aposroot);
    \draw[-,thick](apos2) -- (aposroot);
    \node[treenode,right=of aposroot] (aosproot)        {OSP};
    \node[treenode,below=of aosproot.south west] (aosp1) {\ldots};
    \node[treenode,below=of aosproot.south east] (aosp2) {\ldots};
    \draw[-,thick](aosp1) -- (aosproot);
    \draw[-,thick](aosp2) -- (aosproot);
    
    \node[txt,above=of aposroot]             {+};
    ...
    % Deletion trees    
    \node[treenode,right=of dummy4] (dsporoot)        {SPO};
    \node[treenode,below=of dsporoot.south west] (dspo1) {\ldots};
    \node[treenode,below=of dsporoot.south east] (dspo2) {\ldots};
    \draw[-,thick](dspo1) -- (dsporoot);
    \draw[-,thick](dspo2) -- (dsporoot);
    \node[treenode,right=of dsporoot] (dposroot)        {POS};
    \node[treenode,below=of dposroot.south west] (dpos1) {\ldots};
    \node[treenode,below=of dposroot.south east] (dpos2) {\ldots};
    \draw[-,thick](dpos1) -- (dposroot);
    \draw[-,thick](dpos2) -- (dposroot);
    \node[treenode,right=of dposroot] (dosproot)        {OSP};
    \node[treenode,below=of dosproot.south west] (dosp1) {\ldots};
    \node[treenode,below=of dosproot.south east] (dosp2) {\ldots};
    \draw[-,thick](dosp1) -- (dosproot);
    \draw[-,thick](dosp2) -- (dosproot);
    
    \node[txt,above=of dposroot]             {-};
