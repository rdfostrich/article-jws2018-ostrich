...
\pagestyle{empty}
\begin{tikzpicture}
    \begin{axis}[width=7cm,height=3cm,xmax=10,ymax=6,ytick={2,4,6}]
        \addplot[color=one,thick,mark=*,mark options={solid,fill=one},mark size=0.3] table [x=version, y=accsizegb, col sep=comma] {data/ingest/ostrich.csv};
    \end{axis}
