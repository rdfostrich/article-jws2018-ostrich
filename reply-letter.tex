...
\rv{Are we saying that we will not scale beyond this? Or are we saying that what BEAR tests is already outside of the boundaries of what real-world systems would do?}
...
\rv{briefly explain why separately}
